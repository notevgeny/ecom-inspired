  ...
  return (
    <div className={style.top}>
        <Container className={style.container}>
            ...
            <a className={style.logo} href="/"><img src={logo} alt="logo" /></a>
                    ...
                    <li className={style.navItem}>
                        <a className={style.link} href="/">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M8.25 6.75C8.25 5.75544 8.64509 4.80161 9.34835 4.09835C10.0516 3.39509 11.0054 3 12 3C12.9946 3 13.9484 3.39509 14.6517 4.09835C15.3549 4.80161 15.75 5.75544 15.75 6.75" strokeWidth="2" strokeLinecap="round" stroke="currentColor" strokeLinejoin="round"/>
                            </svg>
                        </a>
                    </li>
                    <li className={style.navItem}>
